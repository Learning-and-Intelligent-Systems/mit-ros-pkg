...
private:
   ...
   *
   */
  typedef actionlib::ActionServer<ee_cart_imped_control::EECartImpedAction> 
  EECIAS;
  ...
  ee_cart_imped_control::EECartImpedResult result_;
  ...
  ee_cart_imped_control::EECartImpedGoal current_traj_;

  /**
   *\brief The state of the controller at the last message received via 
   *EECartImpedExecuter::sub_controller_state_
   */
  ee_cart_imped_control::EECartImpedFeedbackConstPtr last_controller_state_;
   ...
   *<a href=http://www.ros.org/doc/api/ee_cart_imped_control/html/msg/EECartImpedFeedback.html>EECartImpedFeedback</a> 
   *message that is the current controller state as published on state.
   *
   */
  void controllerStateCB(const ee_cart_imped_control::EECartImpedFeedbackConstPtr
			 &msg);
   ...
   *msg->desired.pose in any Cartesian direction or, msg->desired.is_wrench
...
public:
   ...
   *<A href=http://www.ros.org/wiki/ee_cart_imped_control>controller</A> 

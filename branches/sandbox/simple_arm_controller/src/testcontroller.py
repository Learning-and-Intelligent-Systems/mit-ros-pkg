...
point1 = JointTrajectoryPoint(jointangles, jointvelocities, jointaccelerations, time_for_motion)
goal.trajectory.points = [point1,]
joint_action_client.send_goal(goal)
time.sleep(1.0)


point2 = JointTrajectoryPoint([0]*7, [0]*7, [0]*7, rospy.Duration(3.0))
goal.trajectory.points = [point2,]
joint_action_client.send_goal(goal)
time.sleep(.030)
goal.trajectory.points = [point1,]
joint_action_client.send_goal(goal)

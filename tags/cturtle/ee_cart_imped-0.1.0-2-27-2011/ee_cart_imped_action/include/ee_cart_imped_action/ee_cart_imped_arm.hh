 ...
 *
 */
typedef actionlib::SimpleActionClient<ee_cart_imped_control::EECartImpedAction>
EECartImpedClient;
...
public:
   ...
   *
   */
  void startTrajectory(ee_cart_imped_control::EECartImpedGoal goal);
   ...
   *
   */
  static void addTrajectoryPoint(ee_cart_imped_control::EECartImpedGoal &goal, 

...
import time
import math
import lis_arm_controller.arm_manager as controller_manager
...
class ArmTestManager():
    def __init__(self):
        ...
        self.cms = [controller_manager.ArmManager('r', self.tf_listener, self.use_slip_detection), 
                    controller_manager.ArmManager('l', self.tf_listener, self.use_slip_detection)]

...
import rospy
import actionlib
import ee_cart_imped_control.msg
...
class EECartImpedClient:
    ...
    def __init__(self, arm_name):
        ...
        self.client =\
            ...
            ('/'+arm_name[0]+\
                 ...
                 ee_cart_imped_control.msg.EECartImpedAction)
        '''
        ...
        self.goal = ee_cart_imped_control.msg.EECartImpedGoal()
        '''
    ...
    def moveToPoseStamped(self, pose_stamped, time):
        ...
        '''
        goal = ee_cart_imped_control.msg.EECartImpedGoal()
        new_point = len(goal.trajectory);
        goal.trajectory.append(ee_cart_imped_control.msg.StiffPoint())
    ...
    def addTrajectoryPoint(self, x, y, z, ox, oy, oz, ow,
        ...
        self.goal.trajectory.append(ee_cart_imped_control.msg.StiffPoint())

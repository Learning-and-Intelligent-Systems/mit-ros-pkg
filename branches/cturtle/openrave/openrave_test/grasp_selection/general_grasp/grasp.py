...
from general_grasp.com_estimation import *

class Grasp:
    def __init__(self,robot,target,Tgrasp,gripper_angle_start=.548,target_mass = 1.0,coefficient_of_friction = .2, effort = .1):

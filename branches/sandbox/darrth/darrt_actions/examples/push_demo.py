...
def main():
    ...
    #tell DARRT to only plan for PUSH
    goal.primitives = [goal.PUSH]

    #when planning for push, we want to sometimes sample the object location

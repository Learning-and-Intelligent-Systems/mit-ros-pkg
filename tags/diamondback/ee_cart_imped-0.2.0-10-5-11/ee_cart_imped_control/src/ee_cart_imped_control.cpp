...
EECartImpedControlClass::sampleInterpolation() {
  ...
  const ee_cart_imped_control::StiffPoint &initial_point = 
  ...
  ee_cart_imped_control::StiffPoint start_point;
  const ee_cart_imped_control::StiffPoint &end_point = 
...
void EECartImpedControlClass::update()
{
    ...
    ee_cart_imped_control::StiffPoint desiredPose = sampleInterpolation();

...
/******************************************************************************
Addons -- Read PLY vertices and faces.
******************************************************************************/
...
PlyVertex *ply_read_vertices(char *ply_file, int *num_vertices)
{
  int i,j,k;
  PlyFile *ply;
  int nelems;
  ...
  ply = ply_open_for_reading(ply_file, &nelems, &elist, &file_type, &version);
...
PlyFace *ply_read_faces(char *ply_file, int *num_faces)
{
  int i,j,k;
  PlyFile *ply;
  int nelems;

...
def talker():
    ...
    add_table_msg.poly.points[0].x = -h/2
    add_table_msg.poly.points[0].y = -w/2
    add_table_msg.poly.points[0].z = z

    add_table_msg.poly.points[1].x = -h/2
    add_table_msg.poly.points[1].y = +w/2
    add_table_msg.poly.points[1].z = z

    add_table_msg.poly.points[2].x = h/2
    add_table_msg.poly.points[2].y = w/2
    add_table_msg.poly.points[2].z = z

    add_table_msg.poly.points[3].x = h/2
    add_table_msg.poly.points[3].y = -w/2
    add_table_msg.poly.points[3].z = z
    add_table_msg.pose.x = x
    add_table_msg.pose.y = y
    add_table_msg.pose.theta = 0
